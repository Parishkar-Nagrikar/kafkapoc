	...
	public List<LotMasterDTO> getLotMasterDTOs()  {
		List<LotMasterDTO> lotMasterDTOList = new ArrayList<LotMasterDTO>();
			...
			try {
				...
				if(i%2 == 0) {
				String json = "{\"lotId\":"+id+ ",\"lotStatus\":\"Created\",\"lotVersion\":1,\"lotCreationType\":\"Auto\",\"totalQuality\":\"Band-I\",\"totalQuantity\":\"20\",\"variety\":7}";
				lotMasterDTOList.add(new ObjectMapper().readValue(json, LotMasterDTO.class));
				}else{
					String json = "{\"lotId\":"+id+ ",\"lotStatus\":\"Created\",\"lotVersion\":1,\"lotCreationType\":\"Auto\",\"totalQuality\":\"Band-I\",\"totalQuantity\":\"20\",\"variety\":null}";
					lotMasterDTOList.add(new ObjectMapper().readValue(json, LotMasterDTO.class));
					}
				}
